...
*
*/
define('APP_BASE_URL', 'https://localhost/crm-v2');
...
*/
define('APP_ENC_KEY', '525e60763a890524fbbd1555e72befde');
 ...
 */
define('APP_DB_USERNAME', 'fskmzcmy_ci_edcrmv2');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'Timd@@2023');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'fskmzcmy_ci_edcrmv2');
